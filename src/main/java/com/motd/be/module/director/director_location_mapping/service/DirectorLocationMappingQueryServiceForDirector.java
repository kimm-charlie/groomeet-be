...
public class DirectorLocationMappingQueryServiceForDirector {

	private final DirectorLocationMappingRepositoryForDirector directorLocationMappingRepositoryForDirector;

	public List<DirectorLocationMapping> findAllByDirectorIdWithLocation(Long directorInfoId) {
		return directorLocationMappingRepositoryForDirector.findAllByDirectorIdWithLocation(directorInfoId);
	}
}
